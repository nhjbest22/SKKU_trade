document.addEventListener("DOMContentLoaded", () => {
  ...
  // 거래 시간 및 장소 추천 버튼 클릭 시
  const recommendButton = document.getElementById("recommendButton");
  console.log("Recommend Button:", recommendButton); // 버튼 요소 확인

  recommendButton.addEventListener("click", function () {
    console.log("Recommend button clicked"); // 버튼 클릭 이벤트 확인
    const message =
      "거래자와 판매자의 시간표에 따라 추천하는 시간과 위치입니다. \n1. 산학협력관 오후 4시 30분\n2. 반도체관 오전 10시 00분 ";
